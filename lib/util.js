...
(function() {
  var KeepAliveAgent, URL, USER_AGENT, flatten, keepAlive, lib, request, securedKeepAlive, transform, unflatten,
    __slice = [].slice;
  ...
  exports.wrapRequest = function(_arg) {
    ...
    req = request.defaults({
      json: true,
      proxy: proxy,
      agent: url.protocol === 'https:' ? securedKeepAlive : keepAlive
    });
